/*
 ...
 Source Database       : tpcreator

 Target Server Type    : MySQL
 Target Server Version : 50538
 File Encoding         : utf-8

 Date: 04/05/2017 14:21:27 PM
*/
...
-- ----------------------------
BEGIN;
INSERT INTO `admin` VALUES ('1', 'admin', '21232f297a57a5a743894a0e4a801fc3', '1', '1|2', '1', '2016-12-05 08:44:13', '2016-12-05 08:44:50', '2014-08-10 15:49:21');
COMMIT;
...
CREATE TABLE `admin_permission` (
  ...
  `desc_txt` varchar(255) NOT NULL DEFAULT '' COMMENT '权限描述',
...
-- ----------------------------
BEGIN;
INSERT INTO `admin_permission` VALUES ('1', '系统权限', '管理后台设置,管理员设置.', '1', '1', '2015-12-18 12:03:42', '2012-03-26 11:00:55'), ('2', '文章权限', '文章,分类,附件设置', '1', '1', '2017-04-03 21:08:06', '2012-03-26 11:01:03');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `article_category` VALUES ('1', '默认分类', '0', '', '0', '1', '2017-04-05 11:13:18', '2012-05-28 13:24:20');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `setting` VALUES ('1', 'attach_thumb_width', '400', '1', '附件图片缩略图宽度', '2017-04-03 23:20:09', '0000-00-00 00:00:00'), ('2', 'attach_thumb_height', '400', '1', '附件图片缩略图高度', '2015-08-22 22:19:27', '0000-00-00 00:00:00'), ('3', 'attach_quality', '90', '1', '图片质量', '2015-08-22 22:19:10', '0000-00-00 00:00:00');
COMMIT;
