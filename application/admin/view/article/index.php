...
<div class="row">
    ...
    <div class="col-md-6">
        <p class="text-right"><a href="<?php echo MODULE_URL; ?>article/save">添加文章</a></p>
    </div>
</div>

<div class="row">
    <div class="col-md-12">
        <form name="form1" id="form1" method="post" action="<?php echo MODULE_URL; ?>article/manage">
                        ...
                        <?php if ($result != null) : ?>
                            <?php foreach ($result as $value) : ?>
                                <tr class="bd_table_tr">
                                    ...
                                    <td><a href="<?php echo MODULE_URL; ?>article/save/?id=<?php echo $value['id']; ?>">编辑</a></td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </tbody>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" id="filterForm">
                <div class="col-md-8">
                <form action="<?php echo MODULE_URL; ?>article/index/" method="get">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="filter_title">标题</label>
                        <input type="text" name="title" class="form-control" id="filter_title" value="<?php echo $title; ?>">
                    </div>
                    
                    <div class="form-group">
                        <label for="filter_author">作者</label>
                        <input type="text" name="author" class="form-control" id="filter_author" value="<?php echo $author; ?>">
                    </div>
                    
                    <div class="form-group">
                        <label for="filter_top">推荐</label>
                        <select name="top" class="form-control" id="filter_top">
                            <option value="">请选择</option>
                            <?php if ($tops != null) : ?>
                                <?php foreach ($tops as $key => $value) : ?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="article_category_id" class="form-control" id="filter_category">
                            <option value="">请选择</option>
                            <?php if ($categorys != null) : ?>
                                <?php foreach ($categorys as $category) : ?>
                    ...
                    <div class="form-group">
                        <label for="filter_admin">管理员</label>
                        <select name="adminId" class="form-control" id="filter_admin">
                            <option value="">请选择</option>
                            <?php if ($admins != null) : ?>
                    ...
                    <a class="btn btn-default" href="<?php echo MODULE_URL; ?>article/index" role="button">清空条件</a>
                </form>
                </div>
            </div>
        </div>
