...
<div class="row">
    ...
    <div class="col-md-6">
        <p class="text-right"><a href="<?php echo MODULE_URL; ?>create/index">返回上一步</a></p>
    </div>
</div>
...
<div class="row">
    <div class="col-md-8">
        ...
        <form action="<?php echo MODULE_URL; ?>create/next" method="post">
            ...
            <input name="table" type="hidden" value="<?php echo tc_get_value(tc_set_value('table')); ?>">
