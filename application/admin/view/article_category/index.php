...
<div class="row">
    <div class="col-md-6">
        <p class="bd_title">文章分类列表</p>
    </div>
    <div class="col-md-6">
        <p class="text-right"><a href="<?php echo MODULE_URL; ?>article_category/save">添加分类</a></p>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
        <form name="form1" id="form1" method="post" action="<?php echo MODULE_URL; ?>article_category/manage">
                        ...
                        <?php if ($result != null) : ?>
                            <?php foreach ($result as $value) : ?>
                                <tr class="bd_table_tr">
                                    ...
                                    <td>
                                        <a href="<?php echo MODULE_URL; ?>/article_category/save/?id=<?php echo $value['id']; ?>">编辑</a> 
                                        <a href="<?php echo MODULE_URL; ?>/article_category/delete/?id=<?php echo $value['id']; ?>" onclick="return confirmAction();">删除</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
