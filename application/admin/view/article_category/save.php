...
<div class="row">
    ...
    <div class="col-md-6">
        <p class="text-right"><a href="<?php echo MODULE_URL; ?>article_category/index">返回列表</a></p>
    </div>
</div>
...
<div class="row">
    <div class="col-md-8">
        ...
        <form action="<?php echo MODULE_URL; ?>article_category/save" method="post">
            ...
            <div class="form-group<?php if (tc_form_error('parent_id')) : ?> has-error<?php endif; ?>">
                ...
                <select name="parent_id" class="form-control" id="input_parent_id">
                    ...
                    <?php if ($categorys != null) : ?>
                        <?php foreach ($categorys as $category) : ?>
                            <option value="<?php echo $category['id']; ?>" <?php if ($row['parent_id'] == $category['id'] || tc_set_value('parent_id') == $category['id']) : ?>selected="selected"<?php endif; ?>><?php echo $category['name']; ?></option>
                        <?php endforeach; ?>
                    <?php endif; ?>
                </select>
                <span id="helpBlock" class="help-block"><?php echo tc_form_error('parent_id'); ?></span>
            </div>
            ...
            <div class="form-group<?php if (tc_form_error('sort')) : ?> has-error<?php endif; ?>">
                <label for="input_sort" class="control-label">排序</label>
                <input type="text" name="sort" id="input_sort" class="form-control" aria-describedby="helpBlock" value="<?php echo tc_get_value(tc_set_value('sort'), $row['sort'], 0); ?>">
                <span id="helpBlock" class="help-block"><?php echo tc_form_error('sort'); ?></span>
            </div>
